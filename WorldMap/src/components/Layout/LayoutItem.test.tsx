...
describe('LayoutItem Component', () => {
  it('renders without crashing', () => {
    ...
    ReactDOM.render(
      <LayoutItem children={<div id="test" />} opacity={1} color={'blue'} width={'3'} height={'3'} />,
      div,
    );
  ...
  it('matches the snapshot', () => {
    const tree = renderer
      .create(<LayoutItem children={<div id="test" />} opacity={1} color={'blue'} width={'3'} height={'3'} />)
      .toJSON();
  ...
  describe('LayoutItem Component Logic', () => {
    ...
    const wrapper = shallow(
      <LayoutItem children={childC} opacity={opacityC} color={colorC} width={widthC} height={heightC} />,
    );
